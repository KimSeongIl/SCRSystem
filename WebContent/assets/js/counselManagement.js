...
var groupByProfessorListAndCount=function(data){
	...
	$("#barChart").click(function(e) {
		   ...
		   requestJsonData("notSuccessStudentListByProfessor.ajax",{professorId:activeBars[0].professorId,departmentId:$('#chart-second-title #selectDiv select').val()},notSuccessStudentListByProfessor);
		});
