...
public class BoardDAO {
	...
	//공지사항 입력 정보 삽입하기 
	public void insertBoard(String bName,String bTitle,String bContent ){
		try(Connection conn=Conn.getConnection();
				PreparedStatement pstmt=conn.prepareStatement("insert into board(board_name,board_title,board_content) values(?,?,?)");){
	...
	public List viewBoard(){
		...
		try(Connection conn=Conn.getConnection();
				PreparedStatement pstmt=conn.prepareStatement("select * from board order by board_id desc");
